<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="vezzzzzz.WebForm2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div style="text-align:center">
        ...
        <div>
            <asp:RadioButtonList ID="lista_Valuti" runat="server" OnSelectedIndexChanged="lista_Valuti_SelectedIndexChanged" AutoPostBack="True" ></asp:RadioButtonList>
        ...
        <div>
            <asp:Label ID="promena" runat="server" Text=""></asp:Label>
        </div>
